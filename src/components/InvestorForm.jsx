 ...
 * beneficiarios y montos de inversión.
 */
  ...
  const onSubmit = async (formData) => {
    ...
    try {
      ...
      const templateParams = {
        to_email: 'steven0palacios@gmail.com',
        ...
        message: `
          ...
          Datos Bancarios:
          - Banco: ${formData.bankName || 'No especificado'}
      ...
      await emailjs.send(
        'service_5cjae5u', // ID del servicio EmailJS que proporcionaste
        'template_qzfxyfb', // ID de la plantilla que proporcionaste
        templateParams,     // Parámetros con datos del formulario
        '1KF3PauCWl8whjUCh' // Reemplaza con tu Public Key de EmailJS
      );
    ...
    <div className="w-full max-w-4xl mx-auto bg-white rounded-xl shadow-lg overflow-hidden">
      ...
      {submitSuccess ? (
        <div className="p-12 text-center animate-fade-in">
          ...
          <h2 className="text-3xl font-bold text-gray-800 mb-4">¡Información enviada con éxito!</h2>
          <p className="text-gray-600 mb-8">Nos pondremos en contacto contigo pronto.</p>
          {/* Botón para reiniciar el formulario */}
          <button
            onClick={() => {setSubmitSuccess(false); setStep(1);}} // Resetea el formulario al estado inicial
        ...
        <>
          ...
          <div className="px-8 pt-8">
            <div className="flex justify-between items-center mb-8">
              <h1 className="text-3xl font-bold text-gray-800">Información de Inversionista</h1>
            ...
            <div className="w-full bg-gray-200 rounded-full h-2.5 mb-8" role="progressbar" aria-valuenow={(step/4)*100} aria-valuemin="0" aria-valuemax="100">
              <div 
          ...
          <form ref={formRef} onSubmit={handleSubmit(onSubmit)} className="p-8" noValidate>
            {/* Renderiza condicionalmente la sección correspondiente al paso actual */}
            {step === 1 && (
              <PersonalInfoSection register={register} errors={errors} setValue={setValue} />
            )}
            ...
            {step === 4 && (
              <InvestmentSection register={register} errors={errors} watch={watch} />
            )}
